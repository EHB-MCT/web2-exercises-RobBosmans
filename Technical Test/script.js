...
async function getData(e){
    ...
    const response = await fetch("https://www.strava.com/oauth/token?client_id=41469&client_secret=0743f07f60f0eca5e78db28f88f78032a10067b8&refresh_token=c6d059e946455c72bfdaa2a4f78e8172c7a200a5 &grant_type=refresh_token", requestOptions)
    return response.json();

    //fetch routes
    let response = await fetch(`https://www.strava.com/api/v3/athletes/15412454/routes?access_token=${accesToken}`);
...
function getNewAccessToken(e){
    ...
    //.then(console.log(result.access_token))
